...
public class IWPersonImpl  extends PMLObjectImpl implements IWPerson, Serializable {
	public IWPersonImpl() {
	}
	
  public IWPersonImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWPersonImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }

	
	public IWPersonImpl(DataObject desc) {
		super(desc);	
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWPerson: properties map null");
  	}
  }
