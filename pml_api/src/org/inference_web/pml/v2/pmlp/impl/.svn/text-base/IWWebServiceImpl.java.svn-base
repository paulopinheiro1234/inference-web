...
public class IWWebServiceImpl  extends PMLObjectImpl implements IWWebService, Serializable {

	public IWWebServiceImpl() {
	}
	
  public IWWebServiceImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWWebServiceImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWWebServiceImpl(DataObject desc) {
		super(desc);
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWWebService: properties map null");
  	}
  }
