...
public class IWSourceImpl  extends PMLObjectImpl implements IWSource, Serializable {

	public IWSourceImpl() {
	}
	
  public IWSourceImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWSourceImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }

	public IWSourceImpl(DataObject desc) {
		super(desc);	
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWSource: properties map null");
  	}
  }
