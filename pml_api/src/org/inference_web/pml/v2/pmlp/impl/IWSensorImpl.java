...
public class IWSensorImpl  extends PMLObjectImpl implements IWSensor, Serializable {	

	public IWSensorImpl() {
	}
	
  public IWSensorImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWSensorImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWSensorImpl(DataObject desc) {
		super(desc);	
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWSensor: properties map null");
  	}
  }
