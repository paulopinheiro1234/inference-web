...
public class IWOrganizationImpl  extends PMLObjectImpl implements IWOrganization, Serializable {

	public IWOrganizationImpl() {
	}
	
  public IWOrganizationImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWOrganizationImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWOrganizationImpl(DataObject desc) {
		super(desc);	
	}
  public List getHasMember () {
  	return getMultipleValueObjectPropertyValue(PMLP.hasMember_lname);

  }
  public void setHasMember(List newList) {
  	setMultipleValueObjectPropertyValue(PMLP.hasMember_lname, newList);
  }
  public void addHasMember(IWAgent newMember) {
  	this.addMultipleValueObjectPropertyValue(PMLP.hasMember_lname, newMember);
  }
  public void addHasMember(String memberURI) {
  	this.addMultipleValueObjectPropertyValue(PMLP.hasMember_lname, memberURI);
  }
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWOrganization: properties map null");
  	}
  }
