...
public class IWDatasetImpl  extends PMLObjectImpl implements IWDataset, Serializable {

	public IWDatasetImpl() {
	}
	
  public IWDatasetImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWDatasetImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }

	
	public IWDatasetImpl(DataObject desc) {
		super(desc);	
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWDataset: properties map null");
  	}
  }
