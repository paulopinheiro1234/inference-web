...
public class IWAgentImpl  extends PMLObjectImpl implements IWAgent, Serializable {

	public IWAgentImpl() {
	}
	
  public IWAgentImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWAgentImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWAgentImpl(DataObject desc) {
		super(desc);	
	}
  ...
  public void addIsMemberOf(String organizationURI) {
  	addMultipleValueObjectPropertyValue(PMLP.isMemberOf_lname, organizationURI);
  }
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWAgent: properties map null");
  	}
  }
