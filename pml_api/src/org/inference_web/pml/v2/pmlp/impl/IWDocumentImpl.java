...
public class IWDocumentImpl  extends PMLObjectImpl implements IWDocument, Serializable {

	public IWDocumentImpl() {
	}
	
  public IWDocumentImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWDocumentImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWDocumentImpl(DataObject desc) {
		super(desc);	
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWDocument: properties map null");
  	}
  }
