...
public class IWInferenceRuleImpl extends PMLObjectImpl implements IWInferenceRule, Serializable  { 

	public IWInferenceRuleImpl() {
	}
  public IWInferenceRuleImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWInferenceRuleImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
  
	public IWInferenceRuleImpl(DataObject desc) {
		super(desc);		
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWInferenceRule: properties map null");
  	}
  }
