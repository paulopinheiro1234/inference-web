...
public class IWFormatImpl  extends PMLObjectImpl implements IWFormat, Serializable {

	public IWFormatImpl() {
	}
	
  public IWFormatImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWFormatImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWFormatImpl(DataObject dObj) {
		super(dObj);	
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWFormat: properties map null");
  	}
  }
