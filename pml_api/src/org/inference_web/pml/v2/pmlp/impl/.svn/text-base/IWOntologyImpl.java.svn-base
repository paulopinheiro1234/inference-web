...
public class IWOntologyImpl  extends PMLObjectImpl implements IWOntology, Serializable {

	public IWOntologyImpl() {
	}
	
  public IWOntologyImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWOntologyImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWOntologyImpl(DataObject desc) {
		super(desc);	
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWOntology: properties map null");
  	}
  }
