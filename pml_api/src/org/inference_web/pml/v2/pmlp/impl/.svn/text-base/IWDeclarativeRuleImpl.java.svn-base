...
public class IWDeclarativeRuleImpl extends PMLObjectImpl implements IWDeclarativeRule, Serializable  { 
	
	public IWDeclarativeRuleImpl() {
	}
  public IWDeclarativeRuleImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWDeclarativeRuleImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }

	public IWDeclarativeRuleImpl(DataObject desc) {
		super(desc);
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWDeclarativeRule: properties map null");
  	}
  }
