...
public class IWWebsiteImpl  extends PMLObjectImpl implements IWWebsite, Serializable {

	public IWWebsiteImpl() {
	}
	
  public IWWebsiteImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWWebsiteImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWWebsiteImpl(DataObject desc) {
		super(desc);
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWWebsite: properties map null");
  	}
  }
