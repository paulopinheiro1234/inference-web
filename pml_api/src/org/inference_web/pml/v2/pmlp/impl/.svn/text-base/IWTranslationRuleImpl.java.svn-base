...
public class IWTranslationRuleImpl extends IWMethodRuleImpl implements IWTranslationRule, Serializable  { 
	

	public IWTranslationRuleImpl() {
	}
  public IWTranslationRuleImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWTranslationRuleImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }

	public IWTranslationRuleImpl(DataObject desc) {
		super(desc);
	}

	public IWLanguage getHasFromLanguage() {
		IWLanguage result = null;
		Object value = getObjectPropertyValue(PMLP.hasFromLanguage_lname);
		if (value != null) {
			try {
				result=(IWLanguage)value;
			} catch (Exception e) {
			}
		}
		return result;
	}
	public void setHasFromLanguage(IWLanguage newLanguage){
		setObjectPropertyValue(PMLP.hasFromLanguage_lname, newLanguage);
	}
	public void setHasFromLanguage(String languageURI){
		setObjectPropertyValue(PMLP.hasFromLanguage_lname, languageURI);
	}
	public IWLanguage getHasToLanguage(){
		IWLanguage result = null;
		Object value = getObjectPropertyValue(PMLP.hasToLanguage_lname);
		if (value != null) {
			try {
				result=(IWLanguage)value;
			} catch (Exception e) {
	...
	public void setHasToLanguage(IWLanguage newLanguage){
		setObjectPropertyValue(PMLP.hasToLanguage_lname, newLanguage);
	}
	public void setHasToLanguage(String languageURI){
		setObjectPropertyValue(PMLP.hasToLanguage_lname, languageURI);
	}
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWTranslationRule: properties map null");
  	}
  }
