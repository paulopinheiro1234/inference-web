...
public class IWInformationImpl  extends PMLObjectImpl implements IWInformation, Serializable {

	public IWInformationImpl() {
	}
	
  public IWInformationImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWInformationImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }

	public IWInformationImpl(DataObject desc) {
		super(desc);	
	}
	...
	public void setHasReferenceSourceUsage(IWSourceUsage newReferenceSourceUsage) {
			setObjectPropertyValue(PMLP.hasReferenceSourceUsage_lname,newReferenceSourceUsage);
	}
