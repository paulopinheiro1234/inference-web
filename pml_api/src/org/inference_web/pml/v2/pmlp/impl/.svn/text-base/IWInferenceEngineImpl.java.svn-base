...
public class IWInferenceEngineImpl  extends PMLObjectImpl implements IWInferenceEngine, Serializable {

	public IWInferenceEngineImpl() {
	}
	
  public IWInferenceEngineImpl(String ontologyURI, String ontologyClassName) {
  	super(ontologyURI, ontologyClassName);
  }
  
  public IWInferenceEngineImpl(String resourceTypeURI) {
  	super(resourceTypeURI);
  }
	
	public IWInferenceEngineImpl(DataObject desc) {
		super(desc);	
	}
	public List getHasInferenceEngineRule() {
		return getMultipleValueObjectPropertyValue(PMLP.hasInferenceEngineRule_lname);
	}
	public void setHasInferenceEngineRule(List newRules) {
		setMultipleValueObjectPropertyValue(PMLP.hasInferenceEngineRule_lname, newRules);
	}
	public void addHasInferenceEngineRule(IWInferenceRule newRule) {
		addMultipleValueObjectPropertyValue(PMLP.hasInferenceEngineRule_lname, newRule);
	}
	public void addHasInferenceEngineRule(String engineURI) {
		addMultipleValueObjectPropertyValue(PMLP.hasInferenceEngineRule_lname, engineURI);
	}
  ...
  public void setUsesInferenceEngine(List newEngines) {
  	setMultipleValueObjectPropertyValue(PMLP.usesInferenceEngine_lname, newEngines);
  }
  ...
  private void setNamePropertyName() {
  	if (properties != null) {
  		...
  		System.out.println("IWInferenceEngine: properties map null");
  	}
  }
